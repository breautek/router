...
describe('URLParser', () => {
    it('$stripURL', () => {
        ...
        expect((parser as any).$stripURL('/login/')).toBe('login');
    });
    ...
    describe('$getParts', () => {
        ...
        it('/login/', () => {
            expect((parser as any).$getParts('/login/')).toEqual([ 'login' ]);
        });
        ...
        it('/login/test', () => {
            expect((parser as any).$getParts('/login/test')).toEqual([ 'login', 'test' ]);
        });

        it('/login/:var', () => {
            expect((parser as any).$getParts('/login/:var')).toEqual([ 'login', ':var' ]);
        });
    });
